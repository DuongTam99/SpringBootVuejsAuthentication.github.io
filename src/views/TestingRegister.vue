<template>
  <div>
    ...
    <section class="h-full gradient-form bg-gray-200 md:h-screen bg-repeat bg-convert bg-[url('https://img.freepik.com/free-vector/minimal-cat-background-line-art-illustration-vector_53876-151371.jpg?w=2000')]">
              ...
              <div class="lg:flex lg:flex-wrap g-0">
                  ...
                  <div class="md:p-12 md:mx-6">
                    <div class="text-center">
                      ...
                      <h4 class="text-xl font-semibold mt-1 mb-12 pb-1">
                        We are MEO Team, hãy là thành viên MEO để thống trị thế giới
                      </h4>
                    </div>
                    ...
                    <div
                      ...
                      class="
                        ...
                        px-6
                        mb-4
                        text-base text-white-700
                        mb-3
                      "
                      :class="
                        successful
                          ? 'bg-blue-100 rounded-lgpy-5px-6mb-4 text-base text-white  -700 mb-3'
                          : 'bg-white-100 rounded-lgpy-5px-6mb-4 text-base text-red-700 mb-3'
                      "
                    >
                      {{ message }}
                    </div>
                ...
                <div
                  class="
                    ...
                    lg:rounded-r-lg
                    rounded-b-lg
                    lg:rounded-bl-none bg-repeat-round bg-containt bg-center bg-[url('https://media.istockphoto.com/illustrations/cute-fat-ninja-cat-in-a-mask-and-a-sword-illustration-id981711772')] 
                  "
                  style="
        ...
        if (isValid) {
          ...
          this.$store.dispatch("auth/register", this.user).then(
            (data) => {
              ...
              this.$vs.notify({title:'Success',text:'Success for register',color:'success'})
            },
            (error) => {
              ...
              this.message =
                ...
                error.message ||
                error.toString();
                this.$vs.notify({title:'Danger',text:'Cannot Register'+this.message,color:'danger'})
