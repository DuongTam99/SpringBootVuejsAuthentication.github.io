    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        ...
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Chào mừng đến <p>với thế giới mèo</p></h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Hãy tham gia thế giới mèo đầy vui nhộn với nhiều vai trò</p>
                <a href="#_"
                    class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-orange-200 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0"><router-link to="/register">
                        Đăng kí hôm nay
            </router-link></a>
                <!-- Integrates with section -->
                <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                    <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">Được tài trợ bởi   </p>
                    <div class="flex">
                ...
                <svg class="absolute left-0 max-w-md mt-24 -ml-64 left-svg" viewBox="0 0 423 423"
                    ...
                    <defs>
                        <linearGradient x1="100%" y1="0%" x2="4.48%" y2="0%" id="linearGradient-1">
                            ...
                            <stop stop-color="#FFEBCD" offset="100%" />
                        </linearGradient>
            ...
            <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
                    <img width="500" height="600" src="https://cdn-amz.woka.io/images/I/71I-N1xQbCL.jpg"
